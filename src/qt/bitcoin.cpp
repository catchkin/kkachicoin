...
static void handleRunawayException(std::exception *e)
{
    ...
    QMessageBox::critical(0, "Runaway exception", BitcoinGUI::tr("A fatal error occurred. Kkachicoin can no longer continue safely and will quit.") + QString("\n\n") + QString::fromStdString(strMiscWarning));
    exit(1);
}
...
int main(int argc, char *argv[])
{
    ...
    if (!boost::filesystem::is_directory(GetDataDir(false)))
    {
        ...
        QMessageBox::critical(0, "Kkachicoin",
    ...
    QApplication::setOrganizationName("Kkachicoin");
    QApplication::setOrganizationDomain("fstcoin.bit");
    if(GetBoolArg("-testnet")) // Separate UI settings for testnet
        QApplication::setApplicationName("Kkachicoin-Qt-testnet");
    else
        QApplication::setApplicationName("Kkachicoin-Qt");
