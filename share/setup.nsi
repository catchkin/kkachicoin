...
!define COMPANY "Kkachicoin Core project"
...
!else
InstallDir $PROGRAMFILES\Kkachicoin
!endif
CRCCheck on
XPStyle on
BrandingText " "
...
VIAddVersionKey ProductName "Kkachicoin Core"
...
Section -Main SEC0000
    ...
    # Remove old wxwidgets-based-kkachicoin executable and locales:
    Delete /REBOOTOK $INSTDIR\kkachicoin.exe
    RMDir /r /REBOOTOK $INSTDIR\locale
SectionEnd

Section /o "Download blockchain" SecBootstrap

  CreateDirectory "$APPDATA\Kkachicoin"
  SetOutPath "$APPDATA\Kkachicoin"
  DetailPrint "Downloading https://www.kkachicoin.ca/files/blockchain.exe"
  NSISdl::download /TIMEOUT=30000 https://www.kkachicoin.ca/files/blockchain.exe "$APPDATA\Kkachicoin\bootstrap.exe"
  
  Pop $0
  StrCmp $0 success success
    SetDetailsView show
    DetailPrint "download failed from https://www.kkachicoin.ca/files/blockchain $0"
  success:

  ClearErrors
  
  DetailPrint "Extracting blockchain......."
  nsExec::ExecToLog '"$APPDATA\Kkachicoin\blockchain.exe" -o"$APPDATA\Kkachicoin" -y'
  # Rename "$APPDATA\Kkachicoin\bootstrap" "$APPDATA\Kkachicoin\blockchain.exe"
  ClearErrors

  DetailPrint "Removing existing blockchain files"
  # RMDir /r "$APPDATA\Kkachicoin\blocks"
  # RMDir /r "$APPDATA\Kkachicoin\chainstate"

  Delete "$APPDATA\Kkachicoin\blockchain.exe"
...
Section -post SEC0001
    ...
    CreateShortcut "$SMPROGRAMS\$StartMenuGroup\$(^Name).lnk" $INSTDIR\kkachicoin-qt.exe
    ...
    WriteRegStr HKCR "kkachicoin" "URL Protocol" ""
    WriteRegStr HKCR "kkachicoin" "" "URL:Kkachicoin"
    WriteRegStr HKCR "kkachicoin\DefaultIcon" "" $INSTDIR\kkachicoin-qt.exe
    WriteRegStr HKCR "kkachicoin\shell\open\command" "" '"$INSTDIR\kkachicoin-qt.exe" "%1"'
SectionEnd
...
Section /o -un.Main UNSEC0000
    Delete /REBOOTOK $INSTDIR\kkachicoin-qt.exe
...
Section -un.post UNSEC0001
    ...
    Delete /REBOOTOK "$SMSTARTUP\Kkachicoin.lnk"
